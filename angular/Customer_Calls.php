...
$sql2="INSERT INTO `CustomerCalls`(Note,CallType ,KnownFrom,Receivedby,PhoneNumber,En_Fname,En_Lname,Ar_Fname,Ar_Lname,Date,Reg_By,Honorific,time) VALUES ('$Note','$CallType','$KnownFrom','$Receivedby','$PhoneNumber','$En_Fname','$En_Lname','$Ar_Fname','$Ar_Lname','$date','$seg','$Honorific','$time')";
    ...
    <?php mysqli_close($connection); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name='En_Fname'  required="required"pattern="[a-zA-Z\S]+"/>
   ...
   <div id="dvPassport2" style="display: none">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name='En_Fname'  pattern="[a-zA-Z\S]+"  id="newfield2"/>
